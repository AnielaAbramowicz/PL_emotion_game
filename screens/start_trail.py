...
class StartTrail:
    def __init__(self, root, game_state):
        ...
        self.label = tk.Label(
            self.main_frame,
            text="CZEŚĆ!\nWitaj w grze rozpoznawania emocji!",
            font=("Monocraft", 68),
            bg=bg_color,
            fg=text_color,
            wraplength=1000,
        ...
        self.label2 = tk.Label(
            self.main_frame,
            text="Gotowy? Kliknij przycisk, aby rozpocząć RUNDĘ ĆWICZENIOWĄ!",
            font=("Monocraft", 40),
            bg=bg_color,
            fg=text_color,
            wraplength=1000,
        ...
        self.start_button.bind("<Button-1>", lambda e: self.start_game())
    ...
    def start_game(self):
        ...
        TrialScreen(self.root, self.gs).render()
